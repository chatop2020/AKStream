#  提醒:重庆菲莫科技有限公司,你们在没有告知我,并没有得到我同意的情况下,将AKStream及其相关组件作为你们申请发明专利的内容进行发明专利申请;同时还未按照MIT开源协议将技术来源标记出来,这是违法开源协议的行为,请立即中止或整改你们的侵权行为,目前看到的专利申请号为:CN202110965081.9,特此提醒!
#  AKStream介绍 
## 技术交流QQ群：870526956 
-------
